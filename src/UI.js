...
const light_1 = new THREE.PointLight("white", 0.2, 20, 1);
const light_2 = new THREE.PointLight("white", 0.2, 20, 1);
...
const onmousemove = (e) => {
  ...
  if (intersects.length > 0) {
    ...
    if (isMouseDown && selectedItem) {
      ...
      if (
        selectedItem.userData.normalAxis === AXIS.Y &&
        selectedObject.userData.normalAxis === AXIS.Y
      ) {
  ...
  gltfLoader.load(
    ...
    function (gltf) {
      ...
      temp_bathtub = new THREE.Mesh(
        new THREE.BoxGeometry(
          wallItems.bathtub.width,
          wallItems.bathtub.height,
          wallItems.bathtub.depth
        ),
        InvisibleMat
      );
  ...
  return (
    <div className="container vh-100 overflow-auto">
      ...
      <div className="row content">
        ...
        >
          <h6
            className="trig-btn  py-3 w-100 border-bottom"
            style={{ color: "black" }}
          >
            {" "}
            Room Layout
          ...
          <div className="d-flex flex-wrap w-100">
            <h6 className="trig-btn py-3 w-100" style={{ color: "black" }}>
              {" "}
              Room Dimensions
            </h6>
        ...
        >
          ...
          {isCategory ? (
            <Category isAdd={isAdd} setAdd={setAdd} />
          ) : (
            <>
              <input
                placeholder="Search"
                type="search"
                className="d-flex w-100 rounded-4 shadow-sm"
                style={{ height: 40, border: "none" }}
              />
              <div className="d-flex flex-wrap w-100">
                <div className="d-flex flex-wrap w-100">
                  <div
                    className="card  d-flex align-items-center text-center p-2 rounded w-50"
                    onClick={() => setIsCategory(true)}
                  >
                    <span className="m-2">Baths & Spas</span>
                    <img
                      style={{ width: "70px", scale: "2" }}
        ...
        <div className="col-12 position-relative p-0 m-0">
          ...
          ></div>
          <div id="canvas-container" className="border col-12"></div>
          <div
          ...
          >
            <div>
              <img
                ...
                className={
                  (STORE.view === 0 ? "active " : "") +
                  "btn p-2 bg-light m-3 rounded-1"
                }
                src="assets/ui/2d.svg"
                alt=""
              />
              <img
                ...
                src="assets/ui/3d_view.png"
                alt=""
              />
              <img
                onClick={(e) => (STORE.scale += 0.1)}
                className="d-block shadow-focus btn p-2 bg-light  m-3 rounded-1"
